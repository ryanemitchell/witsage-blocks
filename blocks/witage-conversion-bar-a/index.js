...
export default registerBlockType(
	'witsage-blocks/conversion-bar-a',
	{
		title: __( 'WS Conversion Bar A' ),
		description: __( 'Conversion bar with Form', 'witsageblocks' ),
		...
		keywords: [
			__( 'Conversion bar', 'witsageblocks' ),
		...
		edit: props => {
			...
			return [
				...
				>
					...
					<ServerSideRender
						block="witsage-blocks/conversion-bar-a"
						attributes={ {
